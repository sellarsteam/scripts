...
class Parser(api.Parser):
    def __init__(self, name: str, log: logger.Logger, provider_: SubProvider, storage: ScriptStorage, kw: Keywords):
        ...
        self.men_link = "https://www.asos.com/api/product/search/v2/categories/4209?brand=14269,2986,13623,15177&channel=desktop-web&country=RU&currency=RUB&keyStoreDataversion=3pmn72e-27&lang=ru-RU&limit=250&offset=0&rowlength=4&sort=freshness&store=RU"
        self.women_link = "https://www.asos.com/api/product/search/v2/categories/4172?brand=14269,2986,15177&channel=desktop-web&country=RU&currency=RUB&keyStoreDataversion=3pmn72e-27&lang=ru-RU&limit=250&offset=0&rowlength=4&sort=freshness&store=RU"
        self.headers = {
            'User-Agent': 'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:71.0) Gecko/20100101 Firefox/71.0'
        }

        self.product_link: str = "https://api.asos.com/product/catalogue/v3/products/PRODUCT_ID?sizeSchema=RU&store=RU&keyStoreDataversion=3pmn72e-27&currency=RUB&lang=ru-RU"
    ...
    def execute(
        ...
        try:
            ...
            result.extend([self.catalog, api.MAlert(f'Script is down', self.name)])
