...
class Parser(api.Parser):
    def __init__(self, name: str, log: logger.Logger, provider_: SubProvider):
        ...
        self.link: str = 'https://www.notre-shop.com/collections/footwear/mens?page=1&sort_by=created-descending'
        self.interval: int = 1
        ...
        if mode == 0:
            ...
            for element in catalog_links:
                ...
                if 'yeezy' in element.get('href') or 'air' in element.get('href') or 'dunk' in element.get('href') \
                    ...
                    links.append([api.Target('https://www.notre-shop.com' + element.get('href'), self.name, 0),
                                  'https://www.notre-shop.com' + element.get('href')])
            counter += 1
                ...
                try:
                    if HashStorage.check_target(link[0].hash()):
                        ...
                        available_sizes = list(size.text.replace('\n', '').replace(' ', '')
                                               for size in page_content.xpath('//div[@class="product__sizes "]/div')
                        ...
                        sizes = [api.Size(str(size_data.current_value['public_title'].split(' ')[0]) + ' US',
                                          'https://www.notre-shop.com/cart/' + str(
                        ...
                        result.append(IRelease(
                            ...
                            [
                                FooterItem('StockX', 'https://stockx.com/search/sneakers?s=' +
                                           name.replace(' ', '%20')),
                                FooterItem('Cart', 'https://www.notre-shop.com/cart'),
