...
class Parser(api.Parser):
    def __init__(self, name: str, log: logger.Logger, provider_: SubProvider):
        ...
        self.link: str = 'https://www.a-ma-maniere.com/products.json?limit=1000'
        self.interval: int = 1
            ...
            try:
                ...
                for element in Path.parse_str('$.products.*').match(page_content):
                    if 'yeezy' in element.current_value['handle'] or 'air' in element.current_value['handle'] \
                        ...
                        target = api.Target('https://www.a-ma-maniere.com/products/' + element.
...
if __name__ == '__main__':
    while True:
        print(get('https://www.a-ma-maniere.com/products.json?limit=2', headers={'user-agent': generate_user_agent()}).text)
        print(1)
